...
@Component({
  selector: 'app-wireless-device-management',
  templateUrl: './wireless-device-management.component.html',
  styleUrls: ['./wireless-device-management.component.scss']
})

export class WirelessDeviceManagementComponent implements OnInit {
